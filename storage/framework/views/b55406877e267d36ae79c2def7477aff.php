...
<head>
    ...
    <title>Voin - Profile Settings</title>
            ...
            <nav>
                <div class="sidebar-section">
                    ...
                    <ul class="nav-list">
                        ...
                        <li>
                            <a href="<?php echo e(route('weekly-load')); ?>" class="nav-link <?php echo e(request()->routeIs('weekly-load') ? 'active' : ''); ?>">
                        ...
                        <li>
                            <a href="<?php echo e(route('review-log')); ?>" class="nav-link <?php echo e(request()->routeIs('review-log') ? 'active' : ''); ?>">
                ...
                <div class="sidebar-section">
                    ...
                    <ul class="nav-list">
                        <li>
                            <a href="<?php echo e(route('savings-tracker')); ?>" class="nav-link <?php echo e(request()->routeIs('savings-tracker') ? 'active' : ''); ?>">
                                <span class="nav-text">Savings tracker</span>
                                <span class="nav-link-meta">Cash flow</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('workout-planner')); ?>" class="nav-link <?php echo e(request()->routeIs('workout-planner') ? 'active' : ''); ?>">
                                <span class="nav-text">Workout planner</span>
                                <span class="nav-link-meta">Routine</span>
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('credentials-vault')); ?>" class="nav-link <?php echo e(request()->routeIs('credentials-vault') ? 'active' : ''); ?>">
                ...
                <div class="sidebar-section">
                    ...
                    <ul class="nav-list">
                        ...
                        <li>
                            <?php
                                $formId = 'logout-form-profile';
                            ?>
                            <form method="POST" action="<?php echo e(route('logout')); ?>" id="<?php echo e($formId); ?>" style="display: none;">
                                <?php echo csrf_field(); ?>
                            </form>
                            <a href="#" class="nav-link" onclick="event.preventDefault(); document.getElementById('<?php echo e($formId); ?>').submit();">
        ...
        <main class="main-content">
            ...
            <div class="dashboard-viewport">
                <div class="form-container">
                    ...
                    <div class="section-panel" style="margin-top: 32px;">
                        <div class="card" style="border-color: var(--color-error); background: rgba(223, 59, 59, 0.02);">
